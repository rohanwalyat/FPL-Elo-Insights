  ...
  create  table "fpl_elo"."public_silver"."dim_draft_players__dbt_tmp"
  ...
  (
    WITH players AS (
    SELECT * FROM "fpl_elo"."public_silver"."stg_fpl_draft__players"
),

status AS (
    SELECT * FROM "fpl_elo"."public_silver"."stg_fpl_draft__element_status"
),

entries AS (
    SELECT * FROM "fpl_elo"."public_silver"."stg_fpl_draft__league_entries"
),
